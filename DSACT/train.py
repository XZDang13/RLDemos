...
class Trainer:
    ...
    def update(self, num_iteration:int, batch_size:int):
        for _ in range(num_iteration):
            ...
            critic_loss = DSACT.compute_critic_loss(self.actor, self.critic, self.critic_target, 
            ...
            actor_loss = DSACT.compute_actor_loss(self.actor, self.critic, obs_batch.detach(), self.alpha, self.regularization_weight)
            actor_loss.backward()
